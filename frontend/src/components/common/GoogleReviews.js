      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
            What Mumbai Clients Say on Google
          </h2>
          <div className="inline-flex items-center gap-3 bg-blue-50 px-5 py-3 rounded-full mb-4">
            {/* Google G icon as inline SVG — no broken image */}
            ...
            <span className="text-amber-500 font-bold">★ {OVERALL_RATING}</span>
            <span className="text-gray-500 text-sm">({TOTAL_REVIEWS} reviews)</span>
          </div>
          <div className="block">
            <a
